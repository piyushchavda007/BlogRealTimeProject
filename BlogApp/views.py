...
# send_mail('Hello', 'Very imp msg....','piyushchavda0007@gmail.com',['piyushchavda@outlook.com','jamalesh.p@gmail.com','prasanth369.g@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'piyushchavda0007@gmail.com', [cd['to']])
            sent = True
    else:
        form = EmailSendForm()
